...
export class FacultyComponent implements OnInit {
  ...
  faculty_name: string[] = ['Neha Mehra', 'Sonika Shrivastava', 'Reenu Rajput', 'Priyanka Bamne', 'Aditi Seetha'];
  ...
  showconfirmationCancelT:boolean=false;
  showconfirmationRejoinT:boolean =false;
  showconfirmationCancelP:boolean=false;
  showconfirmationRejoinP:boolean =false;
...
CancelTheory(req:PanelOfTheory){

this.paneloftheoryService.deleteRequest(req);
this.showconfirmationCancelT= true;

}
UpdateTheory(req: PanelOfTheory){
console.log(req)
req.faculties=this.updateTheory.value.faculty;
req.course = this.updateTheory.value.course;
req.subjectCode = this.updateTheory.value.subjectcode;
req.subjectName = this.updateTheory.value.subjectname;
this.paneloftheoryService.updatePanelOfTheory(req);
console.log(req)
this.showconfirmationRejoinT= true;
}
